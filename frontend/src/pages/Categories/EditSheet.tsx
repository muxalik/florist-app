      ...
      <SheetContent className='w-[400px] sm:w-[540px]'>
        <div className='relative w-full h-full'>
          <SheetHeader>
            ...
            <SheetDescription>
              Здесь вы можете изменить категорию. Когда сделаете все изменения,
              нажмите Сохранить.
            </SheetDescription>
          </SheetHeader>
          <Form {...form}>
            ...
            >
              ...
              <div className='grid gap-2'>
                ...
                >
                  <div className='absolute -right-2 -top-2 text-gray-600 flex gap-2'>
                    {!!image ||
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className='flex flex-col'>
                    ...
                    <FormDescription>Можно оставить пустой.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              <SheetFooter className='absolute bottom-0 flex w-full'>
                <Button
                  variant={'outline'}
                  className='flex-1'
                  onClick={(e) => {
